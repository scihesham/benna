    ...
    <div class="row animatee color">
        <div class="col-md-12">
            <div class="well well-sm">
                <form method="post" action="{{url('updatereceipt').'/'.$invoice->id}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="attachment" id="attachment" placeholder="صوره الايصال" />
